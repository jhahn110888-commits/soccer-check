...
with tab2:
    ...
    st.divider()
    pos_data = {}
    st.caption("공격수 (FW)"); c1, c2 = st.columns(2)
    pos_data['fw1'] = position_box("ST(L)", 'fw1')
    pos_data['fw2'] = position_box("ST(R)", 'fw2')

    st.caption("미드필더 (MF)"); c3, c4, c5, c6 = st.columns(4)
    pos_data['mf1'] = c3.position_box("LM", 'mf1')
    pos_data['mf2'] = c4.position_box("CM(L)", 'mf2')
    pos_data['mf3'] = c5.position_box("CM(R)", 'mf3')
    pos_data['mf4'] = c6.position_box("RM", 'mf4')

    st.caption("수비수 (DF)"); c7, c8, c9, c10 = st.columns(4)
    pos_data['df1'] = c7.position_box("LB", 'df1')
    pos_data['df2'] = c8.position_box("CB(L)", 'df2')
    pos_data['df3'] = c9.position_box("CB(R)", 'df3')
    pos_data['df4'] = c10.position_box("RB", 'df4')
